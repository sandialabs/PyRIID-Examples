...
_, train_bg_ss, train_ss = static_syn.generate(fg_seeds_ss=fg_seeds_ss, bg_seeds_ss=bg_seeds_ss)

static_syn.samples_per_seed = 100
_, test_bg_ss, test_ss = static_syn.generate(fg_seeds_ss=fg_seeds_ss, bg_seeds_ss=bg_seeds_ss)
