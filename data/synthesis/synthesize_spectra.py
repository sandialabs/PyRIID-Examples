...
static_syn = StaticSynthesizer(**SYNTHETIC_DATA_CONFIG)

# Synthesize foreground-only samples
fg_ss, _, _ = static_syn.generate(fg_seeds_ss, bg_seeds_ss)

# Synthesize background-only samples
_, bg_ss, _ = static_syn.generate(fg_seeds_ss, bg_seeds_ss)

# Synthesize gross samples
_, _, gross_ss = static_syn.generate(fg_seeds_ss, bg_seeds_ss)
...
two_mix_ss = static_syn.generate(two_mix_seeds_ss, bg_seeds_ss)
